...
\begin{tikzpicture}[overlay,remember picture]
  ...
  \node[text width=8cm,align=center] at ($(current page.center)+(0,-6.5)$) {{\fontsize{16}{20} \selectfont \textcolor{orange}{ \bf 4. Januar}} \\[3pt] Emily Antosch \\[3pt] Florian Tietjen \\[3pt] Karl Döring};
