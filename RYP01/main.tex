...
\begin{tikzpicture}[overlay,remember picture]
  ...
  \node[text width=8cm,align=center] at ($(current page.center)+(0,-6.5)$) {{\fontsize{16}{20} \selectfont \textcolor{orange}{ \bf \today}} \\[3pt] Domenic Heidemann XXX\\[3pt] PF: Emily Antosch 2519935 \\[3pt] Kevin Petri XXX\\[3pt]};
